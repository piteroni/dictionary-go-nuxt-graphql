...
export type PokemonsQuery = { __typename?: 'Query', pokemons: { __typename: 'IllegalArguments', message: string } | { __typename: 'PokemonConnection', nextID: number, items: Array<{ __typename?: 'Pokemon', id: number, name: string, imageURL: string }> } | { __typename: 'PokemonNotFound', message: string } };
